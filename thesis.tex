...
\pwit{W CAŁEJ pracy brakuje odnośników do literatury. Rozumiem np., że
  poniższa sekcja przypomina podstawową terminologię dotyczącą pamięci
  wirtualnej, ale pozostaje mnóstwo niuansów, których nie chcemy tu
  omawiać. Czytelnik powinien się dowiedzieć, gdzie o tych niuansach
  powinien przeczytać. Można dodać akapit o literaturze na początku
  (mniej pracochłonne) lub przy każdym pojęciu umieścić odnośnik do
  konkretnej strony/rodziału któregoś z podręczników (to jest
  b. pracochłonne, być nie we wszystkich ale w niektórych miejscach
  warto to zrobić)}
...
\pwit{Poniższy kod wymaga kilku/nastu zdań komentarza. Podobnie pozostały kod w CAŁEJ pracy}
...
After calling \mintinline{c}{pmap_cold}, the \mintinline{c}{init386} procedure is
